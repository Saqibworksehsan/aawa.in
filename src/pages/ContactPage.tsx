              ...
              <div className="bg-white p-8 rounded-lg shadow-md mb-8">
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-gray-700"><span className="font-medium">Saturday:</span> 9:00 AM - 1:00 PM</p>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gray-50 p-6 rounded-md">
                    <h4 className="font-medium text-gray-900 mb-3">Why Choose AAWA SHOES LLP?</h4>
                    <ul className="space-y-2 text-sm text-gray-700">
                      <li className="flex items-start">
                        <span className="text-brown-600 mr-2">•</span>
                        <span>30+ years of experience in footwear manufacturing</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-brown-600 mr-2">•</span>
                        <span>Premium quality leather sourcing and craftsmanship</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-brown-600 mr-2">•</span>
                        <span>Fully integrated manufacturing facility</span>
                      </li>
                      <li className="flex items-start">
                        <span className="text-brown-600 mr-2">•</span>
                        <span>Trusted by global brands and retailers</span>
                      </li>
                    </ul>
                  </div>
                </div>
